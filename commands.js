...
~~~~~~~~~~~~~~~~~~~~~~ 
*/  
  listsp: ['Poast Lists', 'https://poa.st/lists','Fediverse'],
  dingsp: ['Poast Notifications', 'https://poa.st/notifications','Fediverse'],
  chatp: ['Poast Chat', 'https://poa.st/chats','Fediverse'],
  localp: ['Poast Local', 'https://poa.st/timeline/local','Fediverse'],
  fedip: ['Poast Fedi', 'https://poa.st/timeline/fediverse','Fediverse'],
  bmp: ['Poast Booksmarks', 'https://poa.st/bookmarks','Fediverse'],
  eventsp: ['Poast Fedi', 'https://poa.st/events','Fediverse'],
